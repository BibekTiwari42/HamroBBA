  ...
  return (
    <>
      <main className="min-h-screen bg-white text-gray-900 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100">
        ...
        {/* HERO SECTION */}
        <section className="relative overflow-hidden pt-6 pb-12 lg:pt-20 lg:pb-24">
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 relative z-10">
              ...
              <div className="flex flex-col items-start text-left max-w-xl">
                ...
                <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-[3.5rem] sm:leading-[1.15] dark:text-white">
                  Academic resources for <span className="text-blue-700 dark:text-blue-500">TU BBA</span>, made easy.
                </h1>
                ...
                {/* Hero Stats */}
                <div className="mt-6 flex items-center gap-8 border-l-[3px] border-[#2b7a85] pl-6 lg:mt-8">
                  <div>
